...
from scripts.build_submission import (
    ...
    build,
    read_deck,
    validate_kaggle_entrypoint_order,
)
...
class SubmissionSourceTests(unittest.TestCase):
    ...
    def test_kaggle_entrypoint_must_be_last_top_level_callable(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with self.assertRaisesRegex(ValueError, "expected agent to be last"):
