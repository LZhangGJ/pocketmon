...
exec nice -n 10 ionice -c 3 bash \
  /suedata1/Free/lzhang/pocketmon-runs/experiment7-hourly-image-whitelist-v4-20260815/control/run_isolated_arena_shard_v4_retry.sh "$@"
