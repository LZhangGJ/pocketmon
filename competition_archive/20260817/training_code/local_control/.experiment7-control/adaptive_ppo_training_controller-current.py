...
def build_control(
    ...
    return {
        ...
        "rollout": {
            ...
            "weightPolicy": "bounded latest-cell nudge; full-matrix aggregate drives learner controls",
        },
        "learner": {
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Adapt four PPO chains from complete Arena evidence")
