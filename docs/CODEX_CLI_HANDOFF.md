...
## EVAL-UNSEEDED-001 result (2026-07-21)

The evaluator now runs each game in an independent child and preserves exit code, signal, hard timeout, stdout/stderr, partial evidence, and zero retries. Formal execution used `bwrap --unshare-net` plus the Python network blocker. Implementation commits are `1853cd8`, `1c03932`, and the authorized Stage B addition `d0db91e`.
