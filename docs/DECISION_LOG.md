...
- One formal seed was completed due resource/time constraints: seed 20260720 resumed from a one-batch smoke and completed a full training epoch. Validation loss=0.988601705 (policy=0.792827150, value=0.783098221), sequence exact=0.342558426, set exact=0.356334563, empty accuracy=0, multi-select accuracy=0.208994709, candidate precision/recall=0.386967476/0.391677292.
- Hard offline gate passes: all 15448 validation rows decode legally, legal rate=1.0, invalid actions=0, NaN/OOM/runtime errors=0 in the final run. Best checkpoint is gitignored at `checkpoints/rl_bc_001/seed_20260720_best.pt`, SHA-256 `be895529eaf3ed5f7aa750189d75518549f07ea5ea95cc2a1c9e9ba041d194ba`.
- Failures retained: CUDA peak-memory statistics required setting the current device first; mixed action lengths initially produced all-masked inactive logits and NaN; doraemon02/04 GPUs are sm_61 and incompatible with the installed PyTorch. All were diagnosed without filtering data. Formal seeds 17 and 42 were not run and are not fabricated.
- Decision: legality/data gates pass, but accuracy—especially optional STOP—is too weak for gameplay promotion or offline RL. Improve BC and add a history encoder as a separate follow-up before AWR/IQL. No game smoke was attempted because current checkpoint-to-agent integration would expand scope.
